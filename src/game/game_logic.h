...
constexpr int kSpawnBase =
    6; // enemies spawned per wave before difficulty scaling
constexpr float kEnemyHPScalar =
    1.2F; // global HP multiplier applied after per-type scaling
constexpr float kSellRefundFraction =
    0.33F; // fraction of base cost returned on sell
...
inline int SpawnCount(int diff) { return kSpawnBase + diff; }
